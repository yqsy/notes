...
cd /env
wget http://mirrors.tuna.tsinghua.edu.cn/apache/kafka/2.2.0/kafka_2.12-2.2.0.tgz  -O /tmp/kafka_2.12-2.2.0.tgz
mkdir -p /env/kafka
tar -xvzf /tmp/kafka_2.12-2.2.0.tgz -C /env/kafka --strip 1
