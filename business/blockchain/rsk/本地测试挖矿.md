...
# 设置下一个块被挖出来所具备的参数
buildBlockToMine:591, MinerServerImpl
start:265, MinerServerImpl
run:179, FullNodeRunner
main:34, Start

# 为什么这里也调用了?
buildBlockToMine:591, MinerServerImpl
setFallbackMiningState:196, MinerServerImpl
start:273, MinerServerImpl
run:179, FullNodeRunner
main:34, Start
...
key是BlockHeader`RLP encode`的`keccak256 hash`值. value是区块对象.
